...
/* spiwack: */
  ...
  CHECKOPPFLOAT, CHECKABSFLOAT, CHECKCOMPAREFLOAT, CHECKADDFLOAT,
  CHECKSUBFLOAT, CHECKMULFLOAT, CHECKDIVFLOAT, CHECKSQRTFLOAT,

  CHECKFLOATOFINT63, CHECKFLOATNORMFRMANTISSA,

  CHECKFRSHIFTEXP, CHECKLDSHIFTEXP,
