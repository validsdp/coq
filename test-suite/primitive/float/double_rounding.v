...
Definition result_native := Eval native_compute in (big_vm + small_vm)%float.
Definition check_native := Eval native_compute in (big_vm + one)%float.
